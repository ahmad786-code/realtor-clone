...
const EditListing = () => {
    ...
    // },[navigate, auth.currentUser.uid, listings])
    ...
    const handleSubmit = async (e) => {
        ...
        setLoading(false)
        toast.success("Listing Edit Success")
    ...
    return (
        <main className='max-w-md mx-auto px-2'>
            ...
            <form onSubmit={handleSubmit}>
                ...
                focus:shadow-lg active:bg-blue-800 active:shadow-lg transition duration-150 ease-in-out'>Edit Listing</button>
            </form>
        </main>
    )
}
